...
export function DatePickerRange({ className, onDateChange }: DatePickerRangeProps) {
        ...
        <Popover>
          <PopoverTrigger asChild>
            ...
            >
              ...
              {startDate ? startDate.toLocaleDateString("fr-FR") : <span>Date début</span>}
            </Button>
          </PopoverTrigger>
      ...
      <div className="flex-1">
        <Popover>
          <PopoverTrigger asChild>
            ...
            >
              <CalendarIcon className="mr-2 h-4 w-4" />
              {endDate ? endDate.toLocaleDateString("fr-FR") : <span>Date fin</span>}
            </Button>
          </PopoverTrigger>
          <PopoverContent className="w-auto p-0" align="start">
