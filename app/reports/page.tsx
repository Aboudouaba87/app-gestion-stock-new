...
import { Download, TrendingUp, TrendingDown, DollarSign, Package, Users, ShoppingCart, FileText } from "lucide-react"
...
const GlobalTooltip = ({ x, y, content, visible }: { x: number; y: number; content: string; visible: boolean }) => {
...
export default function ReportsPage() {
  ...
  const warehouseMultiplier = dataByWarehouse[selectedWarehouse as keyof typeof dataByWarehouse].multiplier
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      doc.text("RAPPORT STOCKPRO", pageWidth / 2, yPosition, { align: "center" })
      yPosition += 15
      ...
      const periodText = isCustomPeriod
        ? `Du ${customDateRange.start?.toLocaleDateString("fr-FR")} au ${customDateRange.end?.toLocaleDateString("fr-FR")}`
        : selectedPeriod
      ...
      yPosition += 8
      doc.text(`Entrepôt: ${dataByWarehouse[selectedWarehouse as keyof typeof dataByWarehouse].name}`, 20, yPosition)
      yPosition += 20
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        doc.text("StockPro - Rapport généré automatiquement", pageWidth / 2, pageHeight - 5, { align: "center" })
      }

      // Sauvegarder le PDF
      const fileName = `rapport-stockpro-${selectedPeriod}-${selectedWarehouse}-${new Date().toISOString().split("T")[0]}.pdf`
      doc.save(fileName)
      ...
      toast({
        ...
        description: "Une erreur est survenue lors de la génération du PDF. Vérifiez que jsPDF est disponible.",
        variant: "destructive",
      })
    }
  }
  ...
  const handleExportExcel = () => {
    ...
    setTimeout(() => {
      ...
      csvContent += `Entrepôt,${dataByWarehouse[selectedWarehouse as keyof typeof dataByWarehouse].name}\n\n`
      ...
      a.href = url
      a.download = `donnees-stockpro-${selectedPeriod}-${selectedWarehouse}-${new Date().toISOString().split("T")[0]}.csv`
  ...
  const handlePeriodChange = (value: string) => {
    ...
    toast({
      ...
      description: `Affichage des données pour: ${value === "week" ? "Cette semaine" : value === "month" ? "Ce mois" : value === "quarter" ? "Ce trimestre" : "Cette année"}`,
    })
  }
  ...
  const handleWarehouseChange = (value: string) => {
    ...
    toast({
      ...
      description: `Filtrage par: ${dataByWarehouse[value as keyof typeof dataByWarehouse].name}`,
    })
  }
        ...
        <main className="flex-1 p-6">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex-1">
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Dates personnalisées {isCustomPeriod && <span className="text-green-600 text-xs">(Actif)</span>}
                  </label>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">€{kpis.revenue.toLocaleString()}</p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{kpis.orders.toLocaleString()}</p>
                    <p className="text-sm text-green-600 flex items-center mt-1">
                      <TrendingUp className="h-4 w-4 mr-1" />
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{kpis.clients.toLocaleString()}</p>
                    <p className="text-sm text-green-600 flex items-center mt-1">
                      <TrendingUp className="h-4 w-4 mr-1" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <CardContent>
                <div className="h-80 relative" onMouseMove={updateTooltip}>
                  <svg width="100%" height="100%" viewBox="0 0 600 300">
                    ...
                    {/* Sales area */}
                    <path
                      d={`M50,${260 - (salesData[0]?.sales || 0) / 1000} ${salesData.map((item, i) => `L${50 + i * (550 / (salesData.length - 1))},${260 - item.sales / 1000}`).join(" ")} L600,260 L50,260 Z`}
                      fill="url(#salesGradient)"
                    />

                    {/* Profit area */}
                    <path
                      d={`M50,${260 - (salesData[0]?.profit || 0) / 300} ${salesData.map((item, i) => `L${50 + i * (550 / (salesData.length - 1))},${260 - item.profit / 300}`).join(" ")} L600,260 L50,260 Z`}
                    ...
                    <polyline
                      ...
                      strokeWidth="3"
                      points={salesData
                        .map((item, i) => `${50 + i * (550 / (salesData.length - 1))},${260 - item.sales / 1000}`)
                        .join(" ")}
                    />
                    ...
                    <polyline
                      ...
                      strokeWidth="3"
                      points={salesData
                        .map((item, i) => `${50 + i * (550 / (salesData.length - 1))},${260 - item.profit / 300}`)
                        .join(" ")}
                    />
                    ...
                    {salesData.map((item, i) => (
                      <g key={i}>
                        <circle
                          cx={50 + i * (550 / (salesData.length - 1))}
                          cy={260 - item.sales / 1000}
                          r="6"
                          fill="#3b82f6"
                          ...
                          onMouseEnter={(e) =>
                            showTooltip(
                              e,
                              `<strong>${item.month}</strong><br/>Ventes: €${item.sales.toLocaleString()}<br/>Commandes: ${item.orders}`,
                            )
                          }
                        ...
                        <circle
                          ...
                          onMouseEnter={(e) =>
                            showTooltip(
                              e,
                              `<strong>${item.month}</strong><br/>Profit: €${item.profit.toLocaleString()}<br/>Marge: ${((item.profit / item.sales) * 100).toFixed(1)}%`,
                            )
                          }
                          onMouseLeave={hideTooltip}
                        />
                    ...
                    <g transform="translate(50, 20)">
                      ...
                      <text x="90" y="4" fontSize="12" fill="#666">
                        Profits
                      </text>
                    </g>
                  </svg>
            ...
            <Card>
              ...
              <CardContent>
                <div className="h-80 flex items-center justify-center relative" onMouseMove={updateTooltip}>
                  <svg width="280" height="280" viewBox="0 0 280 280">
                    ...
                    <path
                      ...
                      onMouseEnter={(e) =>
                        showTooltip(
                          e,
                          `<strong>${categoryData[0].name}</strong><br/>${categoryData[0].value}% des ventes<br/>€${categoryData[0].sales.toLocaleString()} de CA<br/>Entrepôt: ${dataByWarehouse[selectedWarehouse as keyof typeof dataByWarehouse].name}`,
                        )
                      }
                      onMouseLeave={hideTooltip}
                    />
                    ...
                    <path
                      ...
                      onMouseEnter={(e) =>
                        showTooltip(
                          e,
                          `<strong>${categoryData[1].name}</strong><br/>${categoryData[1].value}% des ventes<br/>€${categoryData[1].sales.toLocaleString()} de CA<br/>Entrepôt: ${dataByWarehouse[selectedWarehouse as keyof typeof dataByWarehouse].name}`,
                        )
                      }
                      onMouseLeave={hideTooltip}
                    />
                    ...
                    <path
                      ...
                      onMouseEnter={(e) =>
                        showTooltip(
                          e,
                          `<strong>${categoryData[2].name}</strong><br/>${categoryData[2].value}% des ventes<br/>€${categoryData[2].sales.toLocaleString()} de CA<br/>Entrepôt: ${dataByWarehouse[selectedWarehouse as keyof typeof dataByWarehouse].name}`,
                        )
                      }
                      onMouseLeave={hideTooltip}
                    />
                    ...
                    <path
                      ...
                      onMouseEnter={(e) =>
                        showTooltip(
                          e,
                          `<strong>${categoryData[3].name}</strong><br/>${categoryData[3].value}% des ventes<br/>€${categoryData[3].sales.toLocaleString()} de CA<br/>Entrepôt: ${dataByWarehouse[selectedWarehouse as keyof typeof dataByWarehouse].name}`,
                        )
                      }
                      onMouseLeave={hideTooltip}
                    />
                    ...
                    {/* Labels dynamiques */}
                    <text x="170" y="85" fontSize="12" fill="white" fontWeight="bold">
                      {categoryData[0].value}%
                    </text>
                    <text x="190" y="140" fontSize="12" fill="white" fontWeight="bold">
                      {categoryData[1].value}%
                    </text>
                    <text x="140" y="195" fontSize="12" fill="white" fontWeight="bold">
                      {categoryData[2].value}%
                    </text>
                    <text x="110" y="140" fontSize="12" fill="white" fontWeight="bold">
                ...
                <div className="h-80 relative" onMouseMove={updateTooltip}>
                  <svg width="100%" height="100%" viewBox="0 0 600 300">
                        ...
                        <g key={i}>
                          <rect
                            ...
                            onMouseEnter={(e) =>
                              showTooltip(
                                e,
                                `<strong>${item.month}</strong><br/>Commandes: ${item.orders}<br/>Ventes: €${item.sales.toLocaleString()}<br/>Panier moyen: €${Math.round(item.sales / item.orders)}`,
                              )
                            }
                            onMouseLeave={hideTooltip}
                          />
                          ...
                          <text x={x} y="270" textAnchor="middle" fontSize="11" fill="#666">
                            {item.month}
                          </text>
                        </g>
                      )
                    ...
                    {[0, 50, 100, 150, 200, 250].map((value, i) => (
                      <text key={i} x="30" y={250 - i * 40} textAnchor="end" fontSize="10" fill="#666">
                        {value}
                      </text>
                    ))}
                  </svg>
              ...
              <CardContent>
                <div className="h-80 relative" onMouseMove={updateTooltip}>
                  <svg width="100%" height="100%" viewBox="0 0 500 300">
                    {/* Grid */}
                    <defs>
                      <pattern id="productGrid" width="50" height="40" patternUnits="userSpaceOnUse">
                        <path d="M 50 0 L 0 0 0 40" fill="none" stroke="#f0f0f0" strokeWidth="1" />
                      </pattern>
                    </defs>
                        ...
                        <g key={i}>
                          <rect
                            ...
                            onMouseEnter={(e) =>
                              showTooltip(
                                e,
                                `<strong>${product.name}</strong><br/>Ventes: ${product.sales} unités<br/>Revenus: €${product.revenue.toLocaleString()}<br/>Prix moyen: €${Math.round(product.revenue / product.sales)}`,
                              )
                            }
                            onMouseLeave={hideTooltip}
                          />
                          <text x="145" y={y + 17} textAnchor="end" fontSize="11" fill="#666">
                            {product.name.length > 15 ? product.name.substring(0, 15) + "..." : product.name}
                          </text>
                          <text x={155 + barWidth} y={y + 17} fontSize="10" fill="white" fontWeight="bold">
                            {product.sales}
                          </text>
                        </g>
                      )
                ...
                <div className="space-y-6" onMouseMove={updateTooltip}>
                  <div
                    ...
                    onMouseEnter={(e) =>
                      showTooltip(
                        e,
                        `<strong>Stock Optimal</strong><br/>${Math.round(1156 * warehouseMultiplier)} produits en stock<br/>Valeur: €${Math.round(2340000 * warehouseMultiplier).toLocaleString()}<br/>Rotation: 4.2x par an`,
                      )
                    }
                    onMouseLeave={hideTooltip}
                  >
                    <div>
                      ...
                      <p className="text-sm text-green-600">{Math.round(1156 * warehouseMultiplier)} produits</p>
                    </div>
                  ...
                  <div
                    ...
                    onMouseEnter={(e) =>
                      showTooltip(
                        e,
                        `<strong>Stock Faible</strong><br/>${Math.round(45 * warehouseMultiplier)} produits en stock faible<br/>Valeur: €${Math.round(89000 * warehouseMultiplier).toLocaleString()}<br/>Réapprovisionnement nécessaire`,
                      )
                    }
                    onMouseLeave={hideTooltip}
                  >
                    <div>
                      ...
                      <p className="text-sm text-orange-600">{Math.round(45 * warehouseMultiplier)} produits</p>
                    </div>
                  ...
                  <div
                    ...
                    onMouseEnter={(e) =>
                      showTooltip(
                        e,
                        `<strong>Rupture de Stock</strong><br/>${Math.round(33 * warehouseMultiplier)} produits en rupture<br/>Perte estimée: €${Math.round(45000 * warehouseMultiplier).toLocaleString()}<br/>Action urgente requise`,
                      )
                    }
                    onMouseLeave={hideTooltip}
                  >
                    <div>
                      ...
                      <p className="text-sm text-red-600">{Math.round(33 * warehouseMultiplier)} produits</p>
                    </div>
                        ...
                        <div className="flex-1 bg-gray-200 rounded-full h-6">
                          <div
                            ...
                            onMouseEnter={(e) =>
                              showTooltip(
                                e,
                                `<strong>Stock Optimal</strong><br/>78% des produits<br/>${Math.round(1156 * warehouseMultiplier)} références<br/>Valeur totale: €${Math.round(2340000 * warehouseMultiplier).toLocaleString()}`,
                              )
                            }
                            onMouseLeave={hideTooltip}
                          >
                        ...
                        <div className="flex-1 bg-gray-200 rounded-full h-6">
                          <div
                            ...
                            onMouseEnter={(e) =>
                              showTooltip(
                                e,
                                `<strong>Stock Faible</strong><br/>15% des produits<br/>${Math.round(45 * warehouseMultiplier)} références<br/>Réapprovisionnement requis`,
                              )
                            }
                            onMouseLeave={hideTooltip}
                          >
                        ...
                        <div className="flex-1 bg-gray-200 rounded-full h-6">
                          <div
                            ...
                            onMouseEnter={(e) =>
                              showTooltip(
                                e,
                                `<strong>Rupture de Stock</strong><br/>7% des produits<br/>${Math.round(33 * warehouseMultiplier)} références<br/>Action urgente nécessaire`,
                              )
                            }
                            onMouseLeave={hideTooltip}
                          >
