                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-600">Être notifié quand un produit atteint le seuil critique</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-600">Recevoir les notifications pour les nouvelles commandes</p>
                    </div>
                    <Switch
